...
// b
//
// learn how to create a linkedlist and use various functions amied at adding or removing from linked lists
/************************************************************/
...
namespace macs262_labs
{
	...
	bool LinkedList::removeFromList(const value_type& entry){ // pretend the list is composed of [5, 10, 15, 20] 
	...
	void LinkedList::printList(){ // this function is not for any functionallity purpouse other than printing to the console what is in the list, used only for debuging. 
		NodePtr current;
