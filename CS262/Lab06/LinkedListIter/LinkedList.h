...
namespace macs262_labs
{
	...
	public:
		...
		node_iterator end() { return node_iterator(NULL); }
		node_iterator begin() { return node_iterator(head); }

		const_node_iterator end() const { return const_node_iterator(NULL); }
		const_node_iterator begin() const { return const_node_iterator(head); }
