// FILE: bst.h (part of the namespace main_savitch_10)
// PROVIDES: A template class for a node in a binary search tree and functions for 
// manipulating search binary trees. The template parameter is the type of data in
// each node.
// 
...
namespace macs262_labs
{
    ...
    template <class Item>
      bool search(binary_tree_node<Item>* root_ptr, const Item& entry);
